...
* @param {string} fen
* @param {BigUint64Array} history
* @returns {TurnInfo}
*/
export function get_turn_data(fen, history) {
    const ptr0 = passStringToWasm0(fen, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray64ToWasm0(history, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.get_turn_data(ptr0, len0, ptr1, len1);
    return TurnInfo.__wrap(ret);
}
...
* @param {string} fen
* @param {BigUint64Array} history
* @param {number} move_ms
* @param {boolean} use_opening_book
* @param {boolean} only_best_book_moves
* @returns {SearchResult}
*/
export function get_computer_move(fen, history, move_ms, use_opening_book, only_best_book_moves) {
    const ptr0 = passStringToWasm0(fen, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray64ToWasm0(history, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.get_computer_move(ptr0, len0, ptr1, len1, move_ms, use_opening_book, only_best_book_moves);
...
* @returns {bigint}
*/
export function fen2hash(fen) {
    const ptr0 = passStringToWasm0(fen, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.fen2hash(ptr0, len0);
...
* @returns {string}
*/
export function make_move(fen, movement) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        const ptr0 = passStringToWasm0(fen, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(movement, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        wasm.make_move(retptr, ptr0, len0, ptr1, len1);
...
export class SearchResult {
    ...
    */
    get best_move() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_searchresult_best_move(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            let v1;
            if (r0 !== 0) {
    ...
    */
    set best_move(arg0) {
        ...
        wasm.__wbg_set_searchresult_best_move(this.__wbg_ptr, ptr0, len0);
    }
    /**
    * @returns {string}
    */
    get eval() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_searchresult_eval(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    */
    set eval(arg0) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_searchresult_eval(this.__wbg_ptr, ptr0, len0);
    }
}
/**
...
export class TurnInfo {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(TurnInfo.prototype);
        obj.__wbg_ptr = ptr;
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_turninfo_free(ptr);
    }
    /**
    * @returns {number}
    */
    get turn_number() {
        const ret = wasm.__wbg_get_turninfo_turn_number(this.__wbg_ptr);
        return ret;
    }
    /**
    * @param {number} arg0
    */
    set turn_number(arg0) {
        wasm.__wbg_set_turninfo_turn_number(this.__wbg_ptr, arg0);
    }
    /**
    * @returns {string}
    */
    ...
    */
    get moves() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_turninfo_moves(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    */
    set moves(arg0) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_turninfo_moves(this.__wbg_ptr, ptr0, len0);
    }
    /**
    * @returns {boolean}
    */
    get in_check() {
        const ret = wasm.__wbg_get_turninfo_in_check(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
    * @param {boolean} arg0
    */
    set in_check(arg0) {
        wasm.__wbg_set_turninfo_in_check(this.__wbg_ptr, arg0);
    }
    /**
    * @returns {string}
    */
    get fen() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_turninfo_fen(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    */
    set fen(arg0) {
        const ptr0 = passStringToWasm0(arg0, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_turninfo_fen(this.__wbg_ptr, ptr0, len0);
    }
}
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('shakmat_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
